...
<div id="fh5co-offcanvas">
    ...
    <div class="fh5co-bio">
        ...
        <ul class="fh5co-social">
            ...
            <li><a href="https://github.com/Lifan-Boy"><i class="icon-github-with-circle"></i></a></li>
            <li><a href="mailto:844125097@qq.com"><i class="icon-mail2"></i></a></li>
        </ul>
    </div>
